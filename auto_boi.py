...
def main(win, width):
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            # This is where to add bits to auto generate start, end and barriers
            # random select start position - row, col
            # random select end position - row, col
            # then start programme
